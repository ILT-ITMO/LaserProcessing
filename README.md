...
- [Реальная архитектура](#реальная-архитектура)
...
**LaserProcessing** - это реальная реализация Physics-Informed Neural Network (PINN) для моделирования 3D процессов лазерного нагрева материалов. Проект поддерживает **два режима работы лазера**:
- **Импульсный режим** (Pulsed) - моделирование последовательности гауссовых импульсов
- **Непрерывный режим** (Continuous) - постоянное лазерное облучение
...
- ✅ **Двухрежимная работа** - поддержка импульсного и непрерывного лазеров
- ✅ **3D PINN модель** - нейросеть решает уравнение теплопроводности в 3D пространстве и времени
- ✅ **Реальная физика** - параметры стекла, поглощение Бугера-Ламберта, начальные и граничные условия
- ✅ **Интерактивный конфигуратор** - веб-интерфейс на Panel для настройки параметров
- ✅ **Профессиональная визуализация** - анимации, 3D срезы, графики профилей
- ✅ **Гибкая конфигурация** - JSON-файлы для сохранения и загрузки параметров
- ✅ **GPU поддержка** - автоматическое выбора устройства (MPS/CUDA/CPU)
