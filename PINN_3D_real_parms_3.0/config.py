...
# ДОБАВИМ: время моделирования для 8 импульсов
NUM_PULSES = 8
SIMULATION_TIME_NORM = NUM_PULSES * LASER_PULSE_PERIOD_NORM
...
print(f"Период импульсов: {LASER_PULSE_PERIOD*1e6:.1f} мкс")
print(f"Время моделирования: {SIMULATION_TIME_NORM * CHARACTERISTIC_TIME*1e6:.1f} мкс ({NUM_PULSES} импульсов)")